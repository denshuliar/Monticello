...
/* harmony import */ var _map_map__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../map/map */ "./src/blocks/map/map.js");
/**
...
function handleWindowScroll() {
  _js_util_lazy_loader__WEBPACK_IMPORTED_MODULE_1__["scanImages"](); // TODO: add code
}
/**
...
function initBlock() {
  ...
  var GM = {
    ...
    initMap: function initMap() {
      ...
      popupContent = this.$popupContent.html(), markerImage = './img/marker.png', zoom = 13.5;
...
/*!******************************!*\
  !*** ./src/js/util/index.js ***!
  \******************************/
/*! exports provided: closest, forceReflow, getTransitionDuration, detectTransitionEnd, animate, scrollTo, debounce, throttle, getEmSize */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getTransitionDuration", function() { return getTransitionDuration; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "detectTransitionEnd", function() { return detectTransitionEnd; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "animate", function() { return animate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "scrollTo", function() { return scrollTo; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "debounce", function() { return debounce; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "throttle", function() { return throttle; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getEmSize", function() { return getEmSize; });
/**
 * @file Utility functions
 */
var matches = Element.prototype.matches || Element.prototype.mozMatchesSelector || Element.prototype.msMatchesSelector || Element.prototype.oMatchesSelector || Element.prototype.webkitMatchesSelector;
/**
...
function getTransitionDuration(el) {
  ...
  var floatDuration = parseFloat(duration.split(','));
  var floatDelay = parseFloat(delay.split(','));
  var msDuration = (floatDuration + floatDelay) * 1000;
...
function detectTransitionEnd(el) {
  ...
  return new Promise(function (resolve) {
    ...
    el.addEventListener('transitionend', handleTransitionEnd, false); // In case the 'transitionend' event is not supported, or is somehow
...
function animate(cb, duration) {
  var startTime = 'now' in window.performance ? window.performance.now() : new Date().getTime();
  ...
  return new Promise(function (resolve) {
    animate(function onStep(progress) {
      if (progress === 1) {
        ...
        window.scroll(leftOffset, startOffset + progress * (targetOffset - startOffset));
      }
    }, duration);
  });
}
...
/***/ "./src/js/util/lazy-loader.js":
/*!************************************!*\
  !*** ./src/js/util/lazy-loader.js ***!
  \************************************/
/*! exports provided: isInViewport, init, scanImages, addImage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "scanImages", function() { return scanImages; });
